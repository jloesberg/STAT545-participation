...
---
title: "jl009 Exercises: tidy data"
...
experiment %>% complete(nesting(name, trt), rep) #complete: fills in all possible combinations, nesting will tie name and trt together so that it doesnt fill in trt b/a for people who didn treceive it
```
