---
title: "jl010 Exercises: Tibble Joins"
output: 
  html_document:
    keep_md: true
    theme: paper
...
```{r}
time %>% 
  left_join(album, by = c("song", "artist_name")) #preserve everything from base tibble and adds extra info from another tibble if its available
```
...
```{r}
time %>% 
  anti_join(album, by = "artist_name") #subtracting out
```
