...
1. uncrowded, easy to follow
1. eye catching, not a lot of white space, but no offensive/garish colors
1. axes make sense
1. you're able to draw your own conlusions from the data
1.
...
- Weak, its just showing how many hours they work, not the drivers behind it...just because they work more doesnt mean they're more motivated...also no measure of uncertainty, errors, sample size. Axes scales are too narrow (if they started it at zero, differences would be less obvious), gridlines and numbers together are too much 

- Main takeaway: Summarize the main takeaway from this question/discussion here
slightly biased to fit paper's argument
...
> 
> Yes, No, Do not know
- X axis title??? y axis should not start at 0 (cant see any variation and obscures the increase - theres actually a 2 degree increase)

- Main takeaway: Summarize the main takeaway from this question/discussion here
- how you frame data has important implications for takeaways
...
>
> Very strong, strong, weak, very week, do not know
- ery week, they flipped the axis!!!

- Main takeaway: Summarize the main takeaway from this question/discussion here
Dont be creative with axis/colors!
...
How to share plotly grpahs: make an account
